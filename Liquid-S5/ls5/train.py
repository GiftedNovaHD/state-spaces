...
def train(args):
    ...
    # Additional: Which GPU is blud running on 
    print("JAX XLA backend is running on", xla_bridge.get_backend().platform)
    if torch.cuda.is_available():
        print("Torch detects GPU backend:", torch.cuda.get_device_name(0))
    else: 
        print("No GPU (Torch)")
    ...
    ssm_init_fn = init_S5SSM(H=args.d_model,
                             ...
                             eigs_handling=args.eigs_handling)
