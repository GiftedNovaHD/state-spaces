python 'run_train.py' --C_init=lecun_normal --activation_fn=full_glu --batchnorm=True \
                    --bidirectional=True --blocks=8 --bsz=50 --d_model=128 --dataset=listops-classification \
                    --epochs=65 --jax_seed=6554595 --lr_factor=3 --n_layers=8 --opt_config=BfastandCdecay \
