import argparse
from ls5.utils.util import str2bool
from ls5.train import train
from ls5.dataloading import Datasets
...
if __name__ == "__main__":
	...
	parser.add_argument("--eigs_handling", type=str, default="rescale",
										 choices=["rescale", "clip",])
